...
(function () {
    ...
    async function saveAttachments(attachmentIds, options) {
        ...
        if (options === undefined) options = { allowSignInPrompt: true, forMSGraphAccess: true};
        //if (options === undefined) options = { allowSignInPrompt: true};
        
        showSpinner();

        // Attempt to get an SSO token
        try {
            console.log("forwardCurrentItem0");
            ...
            console.log("forwardCurrentItem1");
            //forwardCurrentItem(bootstrapToken);
            //getGraphProfile(bootstrapToken);
    ...
    function getGraphProfile(accessToken) {
        // Get the item's REST ID.
        //var itemId = getItemRestId();
        console.log("forwardCurrentItem2");
        var graphUrl = 'https://graph.microsoft.com/v1.0/me/messages'

        // Construct the REST URL to the current item.
        // Details for formatting the URL can be found at
        // https://docs.microsoft.com/previous-versions/office/office-365-api/api/version-2.0/mail-rest-operations#get-messages.
        var getMessageUrl = graphUrl ;
    ...
    function forwardCurrentItem(accessToken) {
        // Get the item's REST ID.
        //var itemId = getItemRestId();
        var itemId = 'AQMkADAwATM0MDAAMS00MmEzLTgyYWUtMDACLTAwCgBGAAADt5zj16wFKEi9Ltov8Di3bAcAmTXYFwEik0OYXZXvEeX1egAAAgEJAAAAmTXYFwEik0OYXZXvEeX1egAAAUPyIwAAAA==';
        console.log("forwardCurrentItem2");
        var graphUrl = 'https://graph.microsoft.com/v1.0/me/messages/'
        ...
        // Details for formatting the URL can be found at
        // https://docs.microsoft.com/previous-versions/office/office-365-api/api/version-2.0/mail-rest-operations#get-messages.
        var getMessageUrl = graphUrl + itemId + '/forward';
    ...
    function handleClientSideErrors(error) {
        console.log("Bsup client side error: " + error.code);
        switch (error.code) {
    ...
    function processMessage(arg) {
        ...
        if (message.status === "success") {
            ...
            //forwardCurrentItem(message.accessToken);
            //getGraphProfile(message.accessToken);
