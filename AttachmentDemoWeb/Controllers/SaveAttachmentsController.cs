...
namespace AttachmentDemoWeb.Controllers
{
    ...
    public class SaveAttachmentsController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Post([FromBody] SaveAttachmentRequest request)
        {
            ...
            string[] graphScopes = { "https://graph.microsoft.com/Files.ReadWrite", "https://graph.microsoft.com/Mail.Read", "https://graph.microsoft.com/Mail.Send" };
            ...
            //return await GraphApiHelper.ForwardMessageBackEnd(authResult.AccessToken, request);
        }
